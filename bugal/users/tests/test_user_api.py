...
# Models
from bugal.base.models import BusinessInfo, BankAccount, Bank

TEST_UUIDS = '9a221efa-6cb9-4857-9f1e-57cfc16078a6'
CREATE_USER_URL = reverse('users:user-signup')
GET_USER_URL = reverse('users:user-detail', kwargs={'uuid': TEST_UUIDS})
LOGIN_USER_URL = reverse('users:rate-detail', kwargs={'uuid': TEST_UUIDS})
